<template>
  <div class="app-container">
    ...
    <section class="relative w-full h-screen overflow-hidden" ref="heroSection">
      <!-- 背景图片层 - 使用public目录下的图片 -->
      <div class="absolute inset-0 z-1 w-full h-full bg-cover bg-center" id="backgroundImage" style="background-image: url(/img/beijing_bg.jpg);"></div>
