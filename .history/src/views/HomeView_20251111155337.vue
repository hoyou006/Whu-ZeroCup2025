<template>
  <div class="app-container">
    ...
    <!-- 视频背景 - 可滚动扩大的区域 -->
      <section class="relative w-full h-screen overflow-hidden" ref="heroSection" style="background-image: url(@/img/bgHome.jpg); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <!-- 背景图片直接应用在section上 -->
