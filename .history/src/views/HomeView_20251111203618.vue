    ...
    <section class="py-20" style="background-color: #549688;">
      <div class="container mx-auto px-4">
        <div class="flex items-center">
          <!-- 左侧竖向文字介绍 -->
          <div class="hidden md:flex items-center justify-center mr-8">
            <div class="writing-vertical text-white font-hei text-4xl md:text-5xl lg:text-6xl font-bold tracking-widest">
              山河图志
            </div>
          </div>
          <!-- 地图区域 -->
