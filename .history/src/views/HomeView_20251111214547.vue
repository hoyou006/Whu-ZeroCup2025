<template>
  <div class="app-container">
    <!-- 导航栏 - 固定在顶部 -->
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-[1000] bg-dark/70 bg-blur">
        <div class="nav-links px-6 py-4 flex justify-center space-x-8 md:space-x-12">
          <router-link to="/" class="nav-item active font-hei text-white hover:text-primary transition-colors duration-300">首页</router-link>
          <router-link to="/RouteView" class="nav-item font-hei text-white/80 hover:text-primary transition-colors duration-300">山河漫游</router-link>
          <router-link to="/Challenge" class="nav-item font-hei text-white/80 hover:text-primary transition-colors duration-300">过关闯将</router-link>
          <router-link to="#" class="nav-item font-hei text-white/80 hover:text-primary transition-colors duration-300">云锦书来</router-link>
        </div>
    </nav>
    ...
    <section class="relative w-full h-screen overflow-hidden" ref="heroSection">
      ...
      <div class="absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4">
        <div class="mb-10 transform translate-y-10 opacity-0" id="mainTitle">
          <h2 style="font-family: 'PingFang SC', '思源黑体 CN', 'Noto Sans SC', 'Ma Shan Zheng', 'STKaiti', 'SimHei', sans-serif; font-weight: bold; font-size: clamp(2rem,8vw,3.5rem); color: white; text-shadow: 0 4px 8px rgba(0, 0, 0, 0.7); letter-spacing: 0.1em; line-height: 1.2;">山河图志</h2>
        </div>
    ...
    <section class="py-20 bg-primary/5">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 style="font-family: 'PingFang SC', '思源黑体 CN', 'Noto Sans SC', 'Ma Shan Zheng', 'STKaiti', 'SimHei', sans-serif; font-weight: bold; font-size: clamp(1.8rem,5vw,3rem); color: var(--color-primary); margin-bottom: 1.5rem;">推荐景点</h2>
