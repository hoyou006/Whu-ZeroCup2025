    ...
    <section class="py-20 bg-primary/5">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-[clamp(1.8rem,5vw,3rem)] font-hei text-primary mb-6">推荐景点</h2>
        ...
        series: [
          {
            ...
            emphasis: {
              label: { show: true, color: '#2F4F4F', fontSize: 16, fontWeight: 'bold' },
              itemStyle: { color: '#F4EAC5', borderWidth: 2 },
              regionHeight: 5,
            },
            light: {
