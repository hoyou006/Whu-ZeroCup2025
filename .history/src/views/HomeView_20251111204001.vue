    ...
    <section class="py-20" style="background-color: #549688;">
      <div class="container mx-auto px-4">
        <div class="flex items-center">
          <!-- 左侧竖向文字介绍 -->
          <div class="flex items-center justify-center mr-4 md:mr-8">
            <div class="writing-vertical text-white font-hei text-3xl md:text-4xl lg:text-5xl font-bold tracking-widest shadow-lg">
              山河图志
            </div>
          </div>
          <!-- 地图区域 -->
