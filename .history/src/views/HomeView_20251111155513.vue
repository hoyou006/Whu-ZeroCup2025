<template>
  <div class="app-container">
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-[1000]">
      ...
      <!-- 视频背景 - 可滚动扩大的区域 -->
      <section class="relative w-full h-screen overflow-hidden" ref="heroSection" style="background-image: url(/img/homePage/bgHome.jpg); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <!-- 背景图片直接应用在section上 -->
      
      <!-- 前景视频层 - 临时隐藏以测试背景图片 -->
      <div class="absolute inset-0 z-2 flex items-center justify-center" style="background-color: transparent; display: none;">
          <div class="relative w-[60vw] h-[40vh] max-w-[800px] max-h-[450px] transition-all duration-1000 ease-out" id="videoContainer" style="opacity: 0.8;">
            <video 
              id="heroVideo"
      ...
      <div class="absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4">
        ...
        <div class="transform translate-y-10 opacity-0" id="subtitle">
          <p class="text-white text-[clamp(0.9rem,2vw,1.1rem)]">方寸图zh</p>
          <p class="text-white/80 text-sm">Scroll to Expand Demo</p>
        </div>
      </div>
