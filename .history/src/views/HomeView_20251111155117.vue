<template>
  <div class="app-container">
    ...
    <section class="relative w-full h-screen overflow-hidden" ref="heroSection">
      <!-- 背景图片层 -->
      <div class="absolute inset-0 z-0 w-full h-full bg-cover bg-center" id="backgroundImage" style="background-image: url(@/img/bgHome.jpg); z-index: 5;"></div>
      
      <!-- 前景视频层 -->
      <div class="absolute inset-0 z-5 flex items-center justify-center" style="background-color: transparent;">
