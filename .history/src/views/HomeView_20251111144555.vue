<template>
  <div class="app-container">
    ...
    <section class="relative w-full h-screen overflow-hidden" ref="heroSection">
      <!-- 背景图片层 -->
      <div class="absolute inset-0 z-0 w-full h-full bg-cover bg-center" id="backgroundImage" style="background-image: url(https://picsum.photos/id/10/1920/1080)"></div>
      ...
      <div class="absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4">
        ...
        <div class="transform translate-y-10 opacity-0" id="subtitle">
          <p class="text-white text-[clamp(0.9rem,2vw,1.1rem)]">Cosmic Journey</p>
